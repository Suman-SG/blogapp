...
//        private static readonly string[] ValidCategories = { "Sports", "Movies", "Cooking", "Technology", "Education", "Travel", "Fashion", "News" ,"Wildlife","Opinon","Dialylife","Other"};
...
//            return View(name, posts); // Looks for Views/Category/{name}.cshtml
//        }
